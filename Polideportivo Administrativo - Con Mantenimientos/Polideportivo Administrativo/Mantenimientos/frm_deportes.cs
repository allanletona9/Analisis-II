...
namespace Polideportivo_Administrativo.Mantenimientos
{
    public partial class frm_deportes : Form
    {
        ...
        void llenarGridEquipos()
        {
            ...
            {
                ds = new DataSet();
                dat = new OdbcDataAdapter("SELECT PK_idDeporte AS Codigo, nombre_deporte AS Nombre, descripcion_deporte AS Descripcion FROM tbl_deportes WHERE estado_deporte=1", conexion.conectar());
                dat.Fill(ds);
        ...
        private void Btn_buscar_Click(object sender, EventArgs e)
        {
            ...
            {
                ds = new DataSet();
                dat = new OdbcDataAdapter("SELECT PK_idDeporte AS Codigo, nombre_deporte AS Nombre, descripcion_Deporte AS Descripcion FROM tbl_deportes WHERE PK_idDeporte='" + Txt_buscar.Text + "' OR nombre_deporte = '" + Txt_buscar.Text + "'", conexion.conectar());
                dat.Fill(ds);
                Dgv_deportes.DataSource = ds.Tables[0];
            }
            catch (OdbcException er)
