            ...
            else if (boton_modificar == true)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            cmd = new OdbcCommand("UPDATE tbl_deportes SET nombre_deporte='" + Txt_nombreDeporte.Text + "', descripcion_deporte='" + Txt_descripcionDeporte + "', estado_deporte=1", conexion.conectar());
                            cmd.ExecuteNonQuery();
                        ...
                        {
                            cmd = new OdbcCommand("UPDATE tbl_deportes SET nombre_deporte='" + Txt_nombreDeporte.Text + "', descripcion_deporte='" + Txt_descripcionDeporte + "', estado_deporte=0", conexion.conectar());
                            cmd.ExecuteNonQuery();
                        }
