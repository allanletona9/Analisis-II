...
namespace Polideportivo_Administrativo.Mantenimientos
{
    public partial class frm_empleados : Form
    {
        ...
        void llenarGridEmpleados()
        {
            ...
            {
                ds = new DataSet();
                dat = new OdbcDataAdapter("SELECT PK_idEmpleado AS Codigo, nombre_empleado AS Nombre, apellido_empleado AS apellido, direccion_empleado AS direccion, dpi_empleado AS DPI, telefono_empleado AS telefono FROM tbl_empleados WHERE estado_empleado=1", nueva.conectar());
                dat.Fill(ds);
        ...
        private void Btn_buscar_Click(object sender, EventArgs e)
        {
            ...
            {
                ds = new DataSet();
                dat = new OdbcDataAdapter("SELECT PK_idEmpleado AS Codigo, nombre_empleado AS Nombre, apellido_empleado AS apellido, direccion_empleado AS direccion, dpi_empleado AS DPI, telefono_empleado AS telefono FROM tbl_empleados WHERE PK_idEmpleado='" + Txt_buscar.Text + "' OR nombre_empleado = '" + Txt_buscar.Text + "'", nueva.conectar());
                dat.Fill(ds);
                Dgv_empleados.DataSource = ds.Tables[0];
            }
            catch (OdbcException er)
