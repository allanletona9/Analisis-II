...
namespace Polideportivo_Administrativo.Mantenimientos
{
    public partial class frm_arbitros : Form
    {
        ...
        void llenarGridArbitros()
        {
            ...
            {
                ds = new DataSet();
                dat = new OdbcDataAdapter("SELECT PK_idArbitro AS Codigo, nombre_arbitro AS Nombre, apellido_arbitro as Apellido FROM tbl_arbitros WHERE estado_arbitro=1", nueva.conectar());
                dat.Fill(ds);
        ...
        private void Btn_buscar_Click(object sender, EventArgs e)
        {
            ...
            {
                ds = new DataSet();
                dat = new OdbcDataAdapter("SELECT PK_idArbitro AS Codigo, nombre_arbitro AS Nombre, apellido_arbitro as Apellido tbl_arbitro WHERE PK_idArbitro=" + Txt_buscar.Text , nueva.conectar());
                dat.Fill(ds);
                Dgv_arbitros.DataSource = ds.Tables[0];
            }
            catch (OdbcException er)
