...
namespace Polideportivo_Administrativo.Mantenimientos
{
    public partial class frm_adminCampeonatos : Form
    {
        ...
        private void Btn_ingresar_Click(object sender, EventArgs e)
        {
            ...
            {
                int scodigoCampo = 0;
                OdbcCommand sql = new OdbcCommand("SELECT MAX(PK_idCampeonato) FROM tbl_campeonatos", nueva.conectar());
                ...
                Txt_codigoCampeonato.Text = sSumaCodigo;
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (bBoton_ingreso == true)
            {
                ...
                try
                {
                    ...
                    if ((Txt_nombreCampeonato.Text == "" || Txt_descripcionCampeonato.Text == "" || Txt_precioCampeonato.Text == ""|| Txt_cantidadEquipos.Text == "" || Cbo_deportes.SelectedIndex.Equals(-1)))
                    {
        ...
        private void Txt_precioCampeonato_KeyPress(object sender, KeyPressEventArgs e)
        {
            Validar.soloNumeros(e);
        }

        private void Txt_cantidadEquipos_KeyPress(object sender, KeyPressEventArgs e)
        {
            Validar.soloNumeros(e);
        }
