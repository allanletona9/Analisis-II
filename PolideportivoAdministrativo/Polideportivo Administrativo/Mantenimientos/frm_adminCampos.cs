        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (boton_ingreso == true)
            {
                ...
                if (ingresoCorrecto)
                {
                    ...
                    cmd = new OdbcCommand("INSERT INTO tbl_bitacora(PK_idUsuario, accion, fecha, hora, tabla, host) VALUES (1,'INSERTAR','" + sFecha + "','" + sHora + "', 'tbl_campos', '" + host + "')", conexion.conectar());
                    cmd.ExecuteNonQuery();
                }
            }
            else if (boton_modificar == true)
            {
                ...
                if (ingresoCorrecto)
                {
                    ...
                    cmd = new OdbcCommand("INSERT INTO tbl_bitacora(PK_idUsuario, accion, fecha, hora, tabla, host) VALUES (1,'MODIFICAR','" + sFecha + "','" + sHora + "', 'tbl_campos', '" + host + "')", conexion.conectar());
                    cmd.ExecuteNonQuery();
                }
            }
            else if (boton_eliminar == true)
            {
                ...
                if (ingresoCorrecto)
                {
                    ...
                    cmd = new OdbcCommand("INSERT INTO tbl_bitacora(PK_idUsuario, accion, fecha, hora, tabla, host) VALUES (1,'ELIMINAR','" + sFecha + "','" + sHora + "', 'tbl_campos', '" + host + "')", conexion.conectar());
                    cmd.ExecuteNonQuery();
                }
            }
        }
