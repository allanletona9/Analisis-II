...
namespace Polideportivo_Administrativo.Mantenimientos
{
    public partial class frm_adminEmpleados : Form
    {
        ...
        private void Btn_ingresar_Click(object sender, EventArgs e)
        {
            ...
            {
                int scodigoCampo = 0;
                OdbcCommand sql = new OdbcCommand("SELECT MAX(PK_idEmpleado) FROM tbl_empleados", nueva.conectar());
                ...
                Txt_codigoEmpleado.Text = sSumaCodigo;
                    ...
                    else
                    {
                        if (Rdb_habilitado.Checked == true)
                        {
                            cmd = new OdbcCommand("UPDATE tbl_empleados SET nombre_empleado='" + Txt_nombreEmpleado.Text + "', apellido_empleado='" + Txt_apellidoEmpleado.Text +
                                  "', direccion_empleado='" + Txt_direccionEmpleado.Text + "', dpi_empleado='" + Txt_dpiEmpleado.Text + "', telefono_empleado='" + Txt_telefonoEmpleado.Text + "', estado_empleado=1", nueva.conectar());
                            cmd.ExecuteNonQuery();
                            cmd.Connection.Close();
                        ...
                        {
                            cmd = new OdbcCommand("UPDATE tbl_empleados SET nombre_empleado='" + Txt_nombreEmpleado.Text + "', apellido_empleado='" + Txt_apellidoEmpleado.Text +
                                "', direccion_empleado='" + Txt_direccionEmpleado.Text + "', dpi_empleado='" + Txt_dpiEmpleado.Text + "', telefono_empleado='" + Txt_telefonoEmpleado.Text + "', estado_empleado=0", nueva.conectar());
                            cmd.ExecuteNonQuery();
                            cmd.Connection.Close();
                        }
