    ...
    public partial class frm_controlSanciones : Form
    {
        ...
        private void Btn_agregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (x == false)
                {
                    ...
                    Bitacora.CrearBitacoraMantenimiento(frm_login.codigo_usuarioparabitacora, frm_login.nombre_usuarioparabitacora, "Asignó Sancion a Jugador", frm_login.IP[2].ToString());
                }
            }
        ...
        private void Btn_eliminar_Click(object sender, EventArgs e)
        {
            ...
            if (x == false)
            {
                ...
                //REGISTRO BITACORA MANTENIMIENTOS-----------------------------------------
                Bitacora.CrearBitacoraMantenimiento(frm_login.codigo_usuarioparabitacora, frm_login.nombre_usuarioparabitacora, "Eliminó Sanción a Jugador", frm_login.IP[2].ToString());
            }
        }
