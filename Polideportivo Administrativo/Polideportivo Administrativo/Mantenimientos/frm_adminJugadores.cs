        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (boton_ingreso == true)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        cmd = new OdbcCommand("INSERT INTO tbl_jugadores(nombre_jugador, apellido_jugador, dpi_jugador, fecha_nacimiento_jugador, telefono_jugador, numeroCamisola_jugador, estado_jugador) VALUES ('" 
                            ...
                            + ", '" + sFechaNacimiento + "', " + Txt_telefono.Text + ", " + Txt_numeroCamisola.Text + ", 1)", conexion.conectar());
                        cmd.ExecuteNonQuery();
                ...
                if (ingresoCorrecto)
                {
                    ...
                    cmd = new OdbcCommand("INSERT INTO tbl_bitacora(PK_idUsuario, accion, fecha, hora, tabla, host) VALUES (1,'INSERTAR','" + sFecha + "','" + sHora + "', 'tbl_jugadores', '" + host + "')", conexion.conectar());
                    cmd.ExecuteNonQuery();
            ...
            else if (boton_modificar == true)
            {
                ...
                if (ingresoCorrecto)
                {
                    ...
                    cmd = new OdbcCommand("INSERT INTO tbl_bitacora(PK_idUsuario, accion, fecha, hora, tabla, host) VALUES (1,'MODIFICAR','" + sFecha + "','" + sHora + "', 'tbl_jugadores', '" + host + "')", conexion.conectar());
                    cmd.ExecuteNonQuery();
                }
            }
            else if (boton_eliminar == true)
            {
                ...
                if (ingresoCorrecto)
                {
                    ...
                    cmd = new OdbcCommand("INSERT INTO tbl_bitacora(PK_idUsuario, accion, fecha, hora, tabla, host) VALUES (1,'ELIMINAR','" + sFecha + "','" + sHora + "', 'tbl_jugadores', '" + host + "')", conexion.conectar());
                    cmd.ExecuteNonQuery();
                }
            }
        }
